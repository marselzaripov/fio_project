  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState7 = React21.useState, useEffect12 = React21.useEffect, useLayoutEffect = React21.useLayoutEffect, useDebugValue = React21.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef6 = React21.useRef, useEffect12 = React21.useEffect, useMemo9 = React21.useMemo, useDebugValue = React21.useDebugValue;
...
// node_modules/@tanstack/query-sync-storage-persister/build/lib/index.esm.js
  ...
  return {
    onFetch: (context) => {
      context.fetchFn = () => {
        ...
        const queryFn17 = context.options.queryFn || (() => Promise.reject("Missing queryFn"));
...
function useClient() {
  const client = React12.useContext(Context);
  if (!client)
    throw new Error(
      [
...
function useBlockNumber({
  ...
  React42.useEffect(() => {
    ...
    const provider_ = webSocketProvider != null ? webSocketProvider : provider;
  ...
  return useQuery2(queryKey({ scopeKey, chainId: chainId2 }), queryFn, {
    cacheTime,
    enabled,
    staleTime,
    suspense,
...
function useAccount({ onConnect, onDisconnect } = {}) {
  ...
  const previousAccountRef = React72.useRef();
  const previousAccount = (_a = previousAccountRef.current) != null ? _a : {};
...
function useConnect({
  ...
  const {
    ...
    status,
    variables
  } = useMutation2(mutationKey({ connector, chainId: chainId2 }), mutationFn, {
    onError,
    onMutate,
    onSettled,
    onSuccess
  ...
  const connect2 = React92.useCallback(
    (args) => {
      var _a, _b;
      return mutate({
        chainId: (_a = args == null ? void 0 : args.chainId) != null ? _a : chainId2,
        connector: (_b = args == null ? void 0 : args.connector) != null ? _b : connector
      });
    },
...
function useSigner({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  const signerQuery = useQuery2(queryKey4({ chainId: chainId2 }), queryFn4, {
    cacheTime: 0,
    staleTime: Infinity,
    suspense,
    onError,
...
function useSignTypedData({
  ...
  const signTypedData2 = React122.useCallback(
    (args) => {
      var _a, _b, _c;
      return mutate({
        domain: (_a = args == null ? void 0 : args.domain) != null ? _a : domain,
        types: (_b = args == null ? void 0 : args.types) != null ? _b : types,
        value: (_c = args == null ? void 0 : args.value) != null ? _c : value
      });
    },
...
function useSwitchNetwork({
  ...
  const {
    ...
    status,
    variables
  } = useMutation2(mutationKey5({ chainId: chainId2 }), mutationFn5, {
    onError,
    onMutate,
    onSettled,
    onSuccess
  ...
  const switchNetwork_ = React13.useCallback(
    (chainId_) => mutate({ chainId: chainId_ != null ? chainId_ : chainId2 }),
    [chainId2, mutate]
  );
  const switchNetworkAsync_ = React13.useCallback(
    (chainId_) => mutateAsync({ chainId: chainId_ != null ? chainId_ : chainId2 }),
  ...
  const supportsSwitchChain = !!((_a = client.connector) == null ? void 0 : _a.switchChain);
  if (throwForSwitchChainNotSupported || supportsSwitchChain) {
    switchNetwork2 = switchNetwork_;
    switchNetworkAsync = switchNetworkAsync_;
  }
  return {
    chains: (_b = client.chains) != null ? _b : [],
    data,
    error,
    isError: isError2,
    isIdle,
...
function useContractEvent({
  ...
  const contract = useContract({
    address,
    abi,
    signerOrProvider: webSocketProvider != null ? webSocketProvider : provider
  });
  ...
  return [
    {
      ...
      chainId: chainId2,
      scopeKey,
      contracts: (contracts != null ? contracts : []).map(
...
function useContractReads({
  ...
  const enabled = React18.useMemo(() => {
    let enabled2 = Boolean(
      enabled_ && (contracts == null ? void 0 : contracts.every((x) => x.abi && x.address && x.functionName))
    );
    if (cacheOnBlock)
      enabled2 = Boolean(enabled2 && blockNumber);
    return enabled2;
  ...
  const abis = (contracts != null ? contracts : []).map(
    ({ abi }) => abi
  );
  return useQuery2(queryKey_, queryFn7({ abis }), {
    ...
    select(data) {
      const result = data.map((data2, i) => {
        var _a;
        const { abi, functionName } = (_a = contracts == null ? void 0 : contracts[i]) != null ? _a : {};
...
function useContractWrite({
  ...
  const write = React19.useCallback(
    (overrideConfig) => {
      ...
      return mutate({
        address,
        args: (_a = overrideConfig == null ? void 0 : overrideConfig.recklesslySetUnpreparedArgs) != null ? _a : args,
        chainId: chainId2,
        abi,
        functionName,
        mode: overrideConfig ? "recklesslyUnprepared" : mode,
        overrides: (_b = overrideConfig == null ? void 0 : overrideConfig.recklesslySetUnpreparedOverrides) != null ? _b : overrides,
        request
      });
    },
    [
...
function useEnsAddress({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  return useQuery2(queryKey10({ chainId: chainId2, name, scopeKey }), queryFn10, {
    cacheTime,
...
function useEnsAvatar({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  return useQuery2(queryKey11({ address, chainId: chainId2, scopeKey }), queryFn11, {
    cacheTime,
...
function useEnsName({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  return useQuery2(queryKey12({ address, chainId: chainId2, scopeKey }), queryFn12, {
    cacheTime,
    enabled: Boolean(enabled && address && chainId2),
    staleTime,
    suspense,
...
function useEnsResolver({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  return useQuery2(queryKey13({ chainId: chainId2, name, scopeKey }), queryFn13, {
    cacheTime,
    enabled: Boolean(enabled && chainId2 && name),
    staleTime,
    suspense,
  ...
  const sendTransaction2 = React20.useCallback(
    (args) => {
      ...
      return mutate({
        chainId: chainId2,
        mode,
        request: (_a = args == null ? void 0 : args.recklesslySetUnpreparedRequest) != null ? _a : request
      });
    },
...
function useTransaction({
  ...
  const chainId2 = useChainId({ chainId: chainId_ });
  return useQuery2(queryKey15({ chainId: chainId2, hash, scopeKey }), queryFn15, {
    cacheTime,
