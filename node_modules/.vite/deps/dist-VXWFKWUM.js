...
var require_dist2 = __commonJS({
  "node_modules/json-rpc-engine/dist/index.js"(exports) {
    ...
    __exportStar(require_createScaffoldMiddleware2(), exports);
...
function h(l3, u3, i3) {
  var t3, o3, r4, f3 = {};
  for (r4 in u3)
    "key" == r4 ? t3 = u3[r4] : "ref" == r4 ? o3 = u3[r4] : f3[r4] = u3[r4];
  if (arguments.length > 2 && (f3.children = arguments.length > 3 ? n.call(arguments, 2) : i3), "function" == typeof l3 && null != l3.defaultProps)
    for (r4 in l3.defaultProps)
      void 0 === f3[r4] && (f3[r4] = l3.defaultProps[r4]);
  return v(l3, f3, t3, o3, null);
}
function v(n2, i3, t3, o3, r4) {
  var f3 = { type: n2, props: i3, key: t3, ref: o3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == r4 ? ++u : r4 };
...
function g() {
  for (var n2; g.__r = t.length; )
    n2 = t.sort(function(n3, l3) {
      ...
      var l3, u3, i3, t3, o3, r4;
      n3.__d && (o3 = (t3 = (l3 = n3).__v).__e, (r4 = l3.__P) && (u3 = [], (i3 = s({}, t3)).__v = t3.__v + 1, j(r4, t3, i3, l3.__n, void 0 !== r4.ownerSVGElement, null != t3.__h ? [o3] : null, u3, null == o3 ? _(t3) : o3, t3.__h), z(u3, t3), t3.__e != o3 && k(t3)));
    });
}
function w(n2, l3, u3, i3, t3, o3, r4, c3, s3, a3) {
  var h3, y3, d3, k3, b3, g3, w3, x3 = i3 && i3.__k || e, C2 = x3.length;
  for (u3.__k = [], h3 = 0; h3 < l3.length; h3++)
    if (null != (k3 = u3.__k[h3] = null == (k3 = l3[h3]) || "boolean" == typeof k3 ? null : "string" == typeof k3 || "number" == typeof k3 || "bigint" == typeof k3 ? v(null, k3, null, null, k3) : Array.isArray(k3) ? v(p, { children: k3 }, null, null, null) : k3.__b > 0 ? v(k3.type, k3.props, k3.key, k3.ref ? k3.ref : null, k3.__v) : k3)) {
      ...
      j(n2, k3, d3 = d3 || f, t3, o3, r4, c3, s3, a3), b3 = k3.__e, (y3 = k3.ref) && d3.ref != y3 && (w3 || (w3 = []), d3.ref && w3.push(d3.ref, null, k3), w3.push(y3, k3.__c || b3, k3)), null != b3 ? (null == g3 && (g3 = b3), "function" == typeof k3.type && k3.__k === d3.__k ? k3.__d = s3 = m(k3, s3, n2) : s3 = A(n2, k3, d3, x3, b3, s3), "function" == typeof u3.type && (u3.__d = s3)) : s3 && d3.__e == s3 && s3.parentNode != n2 && (s3 = _(d3));
    }
  for (u3.__e = g3, h3 = C2; h3--; )
    null != x3[h3] && N(x3[h3], x3[h3]);
  if (w3)
...
function j(n2, u3, i3, t3, o3, r4, f3, e3, c3) {
  var a3, h3, v3, y3, _3, k3, b3, g3, m3, x3, A3, C2, $2, H2, I2, T3 = u3.type;
  if (void 0 !== u3.constructor)
    return null;
  null != i3.__h && (c3 = i3.__h, e3 = u3.__e = i3.__e, u3.__h = null, r4 = [e3]), (a3 = l.__b) && a3(u3);
  try {
    n:
      if ("function" == typeof T3) {
        if (g3 = u3.props, m3 = (a3 = T3.contextType) && t3[a3.__c], x3 = a3 ? m3 ? m3.props.value : a3.__ : t3, i3.__c ? b3 = (h3 = u3.__c = i3.__c).__ = h3.__E : ("prototype" in T3 && T3.prototype.render ? u3.__c = h3 = new T3(g3, x3) : (u3.__c = h3 = new d(g3, x3), h3.constructor = T3, h3.render = O), m3 && m3.sub(h3), h3.props = g3, h3.state || (h3.state = {}), h3.context = x3, h3.__n = t3, v3 = h3.__d = true, h3.__h = [], h3._sb = []), null == h3.__s && (h3.__s = h3.state), null != T3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = s({}, h3.__s)), s(h3.__s, T3.getDerivedStateFromProps(g3, h3.__s))), y3 = h3.props, _3 = h3.state, v3)
          ...
          if (null == T3.getDerivedStateFromProps && g3 !== y3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(g3, x3), !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(g3, h3.__s, x3) || u3.__v === i3.__v) {
        ...
        if (h3.context = x3, h3.props = g3, h3.__v = u3, h3.__P = n2, C2 = l.__r, $2 = 0, "prototype" in T3 && T3.prototype.render) {
        ...
        h3.state = h3.__s, null != h3.getChildContext && (t3 = s(s({}, t3), h3.getChildContext())), v3 || null == h3.getSnapshotBeforeUpdate || (k3 = h3.getSnapshotBeforeUpdate(y3, _3)), I2 = null != a3 && a3.type === p && null == a3.key ? a3.props.children : a3, w(n2, Array.isArray(I2) ? I2 : [I2], u3, i3, t3, o3, r4, f3, e3, c3), h3.base = u3.__e, u3.__h = null, h3.__h.length && f3.push(h3), b3 && (h3.__E = h3.__ = null), h3.__e = false;
      } else
        null == r4 && u3.__v === i3.__v ? (u3.__k = i3.__k, u3.__e = i3.__e) : u3.__e = L(i3.__e, u3, i3, t3, o3, r4, f3, c3);
    (a3 = l.diffed) && a3(u3);
  } catch (n3) {
    u3.__v = null, (c3 || null != r4) && (u3.__e = e3, u3.__h = !!c3, r4[r4.indexOf(e3)] = null), l.__e(n3, u3, i3);
  }
}
function z(n2, u3) {
...
function L(l3, u3, i3, t3, o3, r4, e3, c3) {
  var s3, h3, v3, y3 = i3.props, p3 = u3.props, d3 = u3.type, k3 = 0;
  if ("svg" === d3 && (o3 = true), null != r4) {
    for (; k3 < r4.length; k3++)
  ...
  if (null == l3) {
    ...
    l3 = o3 ? document.createElementNS("http://www.w3.org/2000/svg", d3) : document.createElement(d3, p3.is && p3), r4 = null, c3 = false;
  }
  if (null === d3)
    y3 === p3 || c3 && l3.data === p3 || (l3.data = p3);
  else {
    if (r4 = r4 && n.call(l3.childNodes), h3 = (y3 = i3.props || f).dangerouslySetInnerHTML, v3 = p3.dangerouslySetInnerHTML, !c3) {
      if (null != r4)
    ...
    if (C(l3, p3, y3, o3, c3), v3)
      u3.__k = [];
    else if (k3 = u3.props.children, w(l3, Array.isArray(k3) ? k3 : [k3], u3, i3, t3, o3 && "foreignObject" !== d3, r4, e3, r4 ? r4[0] : i3.__k && _(i3, 0), c3), null != r4)
      for (k3 = r4.length; k3--; )
        null != r4[k3] && a(r4[k3]);
...
function P(u3, i3, t3) {
  var o3, r4, e3;
  l.__ && l.__(u3, i3), r4 = (o3 = "function" == typeof t3) ? null : t3 && t3.__k || i3.__k, e3 = [], j(i3, u3 = (!o3 && t3 || i3).__k = h(p, null, [u3]), r4 || f, f, void 0 !== i3.ownerSVGElement, !o3 && t3 ? [t3] : r4 ? null : i3.firstChild ? n.call(i3.childNodes) : null, e3, !o3 && t3 ? t3 : r4 ? r4.__e : i3.firstChild, o3), z(e3, u3);
}
function S(n2, l3) {
  P(n2, l3, S);
}
function q(l3, u3, i3) {
  var t3, o3, r4, f3 = s({}, l3.props);
  for (r4 in u3)
    "key" == r4 ? t3 = u3[r4] : "ref" == r4 ? o3 = u3[r4] : f3[r4] = u3[r4];
  ...
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = e.slice, l = { __e: function(n2, l3, u3, i3) {
      for (var t3, o3, r4; l3 = l3.__; )
        if ((t3 = l3.__c) && !t3.__)
          try {
            if ((o3 = t3.constructor) && null != o3.getDerivedStateFromError && (t3.setState(o3.getDerivedStateFromError(n2)), r4 = t3.__d), null != t3.componentDidCatch && (t3.componentDidCatch(n2, i3 || {}), r4 = t3.__d), r4)
              return t3.__E = t3;
          } catch (l4) {
            n2 = l4;
          }
  ...
  "node_modules/@coinbase/wallet-sdk/dist/CoinbaseWalletSDK.js"(exports) {
    ...
    var CoinbaseWalletSDK = class {
      constructor(options) {
        ...
        const u3 = new URL(linkAPIUrl);
        const origin = `${u3.protocol}//${u3.host}`;
...
//# sourceMappingURL=dist-VXWFKWUM.js.map
