import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-IZ4JC7YC.js";
import {
  Container_default
} from "./chunk-WG7QN7TC.js";
import {
  Col_default,
  ...
  require_warning,
  useCol
} from "./chunk-XQYVDXPD.js";
import {
  require_prop_types
} from "./chunk-WWDKHNPQ.js";
import {
  Button_default as Button_default2
} from "./chunk-EORHAU3Y.js";
import {
  Anchor_default,
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-TKB3F65E.js";
import {
  createWithBsPrefix
} from "./chunk-R2UEJKC5.js";
import {
  Button_default
} from "./chunk-FVR6O3SK.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-ZBVWZUMU.js";
import {
  require_jsx_runtime
} from "./chunk-APZ3PUCN.js";
import {
  require_react_dom
} from "./chunk-VRTNVW7U.js";
import {
  require_react
...
var ModalHeader = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime39.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime40.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal = React39.forwardRef(({
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime40.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime40.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime40.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime40.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime40.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavDropdown = React40.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime42.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames30.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime41.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime41.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay = React41.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime43.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
var Popover = React43.forwardRef(({
  ...
  return (0, import_jsx_runtime45.jsxs)("div", {
    ...
    className: (0, import_classnames31.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime48.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react28.cloneElement)(children, triggerProps), (0, import_jsx_runtime47.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Spinner = React53.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React54.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react30.useRef)(inProp);
...
var TabPanel = React56.forwardRef(
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var Table = React61.forwardRef(({
  ...
  const classes = (0, import_classnames42.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React63.forwardRef((props, ref) => (0, import_jsx_runtime71.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React66.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime74.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames44.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React67.forwardRef(({
  ...
  return (0, import_jsx_runtime75.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames45.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
var ToggleButton = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime77.Fragment, {
    children: [(0, import_jsx_runtime76.jsx)("input", {
      ...
      ...props,
      ref,
      className: (0, import_classnames46.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
